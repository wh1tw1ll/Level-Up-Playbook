...
window.__MFP_FINANCIALS = {
  hard: {
    ...
    total_approved_cos: 20679147.32,
    total_revised: 505404567.31,
    total_pending_cos: 4825759.17,
    total_invoiced: 459198110.66,
    total_paid: 399979579.48,
    total_pct_paid: 79.14,
    total_balance: 105424987.83,
    ...
    commitments: [
      ...
      {company:"Metromont LLC",title:"Precast — Metromont",contract:"19069-SC-002",orig:13296238.00,co:3440069.26,revised:16736307.26,invoiced:15072447.79,paid:15072448.28,pct_paid:90.06,balance:1663858.98},
      {company:"BAKER CONCRETE CONSTRUCTION INC.",title:"Cast-in-Place Concrete",contract:"19069-SC-003",orig:51490000.00,co:10309815.07,revised:61799815.07,invoiced:59104998.88,paid:57071802.07,pct_paid:92.35,balance:4728013.00},
      ...
      {company:"GEORGE'S WELDING SERVICES, INC.",title:"Misc Metals",contract:"19069-PO-004",orig:4650000.00,co:-246167.11,revised:4403832.89,invoiced:3923624.53,paid:1865271.96,pct_paid:42.36,balance:2538560.93},
      ...
      {company:"SPRINKLERMATIC FIRE PROTECTION SYSTEMS, INC.",title:"Fire Suppression",contract:"19069-SC-008",orig:2317180.00,co:575928.00,revised:2893108.00,invoiced:2494706.39,paid:2005410.60,pct_paid:69.32,balance:887697.40},
      ...
      {company:"RIGHT WAY PLUMBING & MECHANICAL LLC",title:"Underground Plumbing",contract:"UNKNOWN",orig:19889328.00,co:299971.77,revised:20189299.77,invoiced:19179835.11,paid:15093373.49,pct_paid:74.76,balance:5095926.28}
    ],
      },
      soft: {
    // Soft Costs from MFP Master Design Consultant Log (Stadium only)
    design_total: 28451538.00,
    design_total_approved_asas: 0,  // TODO: populate from design consultant CO log
    design_team: [
      {firm:"MANICA Architecture",scope:"Design Architect",fee:5289750,approved_asas:0},
      {firm:"Arquitectonica (ARQ)",scope:"Architect of Record",fee:6964543,approved_asas:0},
      {firm:"ARQ Interiors",scope:"Interior Design",fee:476025,approved_asas:0},
      {firm:"Thornton Tomassetti",scope:"Structural Engineering",fee:3452120,approved_asas:0},
      {firm:"Schlaich Bergermann Partner (SBP)",scope:"Canopy Structural Design",fee:1574400,approved_asas:0},
      {firm:"WJHW",scope:"Acoustical / Low Voltage / Communications",fee:3452120,approved_asas:0},
      {firm:"Smith Seckman Reid (SSR)",scope:"MEP Engineering",fee:2501594,approved_asas:0},
      {firm:"Kimley-Horn",scope:"Civil Engineering",fee:566500,approved_asas:0},
      {firm:"Gensler",scope:"Signage & Wayfinding",fee:1207000,approved_asas:0},
      {firm:"HLB",scope:"Specialty Lighting",fee:291583,approved_asas:0},
      {firm:"SOCOTEC / SLS",scope:"Fire & Life Safety / Accessibility",fee:407500,approved_asas:0},
      {firm:"SOCOTEC / SLS",scope:"LEED Certification",fee:237006,approved_asas:0},
      {firm:"Duray",scope:"Food & Beverage Consulting",fee:168400,approved_asas:0},
      {firm:"Millennium",scope:"Field Design",fee:140000,approved_asas:0},
      {firm:"BCNO.3",scope:"Project Manual",fee:135000,approved_asas:0},
      {firm:"Persohn/Hahn",scope:"Vertical Transportation",fee:58775,approved_asas:0},
      {firm:"Divergent Thinkers",scope:"BIM + 4D Modeling",fee:372000,approved_asas:0},
      {firm:"Cini-Little",scope:"Waste Management Consulting",fee:29225,approved_asas:0},
      {firm:"Pacifica",scope:"Material Testing & Inspection",fee:318829,approved_asas:0},
      {firm:"Smith-Emery",scope:"Steel Testing & Inspection",fee:417083,approved_asas:0},
      {firm:"ViewPointe Consulting",scope:"Permit Expediting",fee:188835,approved_asas:0},
      {firm:"BNI",scope:"Structural Peer Review",fee:48000,approved_asas:0},
      {firm:"Studio08",scope:"Door Hardware Consulting",fee:55250,approved_asas:0}
    ],
  ...
  summary: {
    ...
    paid_to_date: 399979579.48,
    incurred_to_date: 459198110.66,
    past_due: 11779630,
    stadium_base_contract: 505404567.31,
