...
.rail .rlogo{width:38px;height:38px;border-radius:8px;background:var(--gold);display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:800;color:var(--navy-d);margin-bottom:18px}
...
function renderOverview(){
  ...
  html+='<div class="kpi-ticker">'
    +'<div class="kpi-cell"><div class="value">'+money(totMay)+'</div><div class="label">Total Budget</div></div>'
  ...
  html+='<div class="card"><div class="card-header" onclick="toggleSec(this)"><span class="chev">&#9660;</span><span class="chv">PROJECT HEALTH, DOCUMENTS & CAMERA</span></div><div class="card-body">'
    ...
    +'<tr><td>Budget</td><td><span class="health-dot g"></span><strong style="color:var(--green)">On Track</strong></td></tr>'
    +'<tr><td>Schedule</td><td><span class="health-dot a"></span><strong style="color:var(--amber)">Watch</strong><span style="color:var(--muted);font-size:11px;margin-left:6px">~90 days to groundbreaking</span></td></tr>'
    ...
    +'<tr><td>Risk</td><td><span class="health-dot g"></span><strong style="color:var(--green)">Green</strong></td></tr>'
    +'<tr><td>Quality</td><td><span class="health-dot g"></span><strong style="color:var(--green)">Green</strong></td></tr>'
    +"</table>"
    +'<div class="doc-grid">'
...
function renderBudget(){
  ...
  html+='<div class="kpi-ticker">'
    +'<div class="kpi-cell"><div class="value">'+money(totMay)+'</div><div class="label">Total Budget</div></div>'
    +'<div class="kpi-cell"><div class="value">$1.5M</div><div class="label">Committed</div></div>'
    +'<div class="kpi-cell"><div class="value">$1.3M</div><div class="label">Billed to Date</div></div>'
    +'<div class="kpi-cell"><div class="value">TBD</div><div class="label">Forecast Variance</div></div>'
    +'<div class="kpi-cell"><div class="value">'+money(26312033)+'</div><div class="label">Contingency Remaining</div></div>'
  ...
  else cats.forEach(function(x){html+='<tr><td>'+esc(get(x,["Category"]))+'</td><td>'+fmtM(get(x,["Planned"]))+'</td><td>'+fmtM(get(x,["Committed"]))+'</td><td>'+fmtM(get(x,["Spent to Date"]))+'</td><td>'+fmtM(get(x,["Forecast at Completion"]))+'</td><td>'+(get(x,["Variance"])||"&mdash;")+'</td><td>'+(get(x,["Percent Spent"])||"&mdash;")+'</td><td>'+fmtM(get(x,["Contingency Used"]))+'</td><td>'+pill(get(x,["Status"]))+"</td></tr>"});
  html+="</tbody></table></div></div>";
...
function renderSchedule(){
  ...
  html+='<div class="card"><div class="card-header" onclick="toggleSec(this)"><span class="chev">&#9660;</span><span class="chv">SCHEDULE MILESTONES <span style="font-weight:400;color:var(--muted)">'+s05.length+" milestones</span></span></div><div class=\\"card-body\\">"
    +'<table><thead><tr><th>ID</th><th>DESCRIPTION</th><th>START</th><th>FINISH</th><th>PHASE</th></tr></thead><tbody>';
  if(!s05.length)html+='<tr><td colspan="5" class="no-data">No schedule data</td></tr>';
  else s05.forEach(function(x){html+='<tr><td>'+esc(get(x,["Milestone ID"]))+'</td><td>'+esc(get(x,["Description"]))+'</td><td>'+esc(get(x,["Planned Start"]))+'</td><td>'+esc(get(x,["Planned Finish"]))+'</td><td>'+pill(get(x,["Phase"]),"blue")+"</td></tr>"});
  html+="</tbody></table></div></div>";

  html+='<div class="card"><div class="card-header" onclick="toggleSec(this)"><span class="chev">&#9660;</span><span class="chv">PERMITTING SCHEDULE <span style="font-weight:400;color:var(--muted)">Gating path</span></span></div><div class="card-body">'
    +'<table><thead><tr><th>PHASE</th><th>SUBMITTAL</th><th>APPROVAL</th><th>STATUS</th></tr></thead><tbody>'
    +'<tr><td>MDR Final Submittal</td><td>Jun-Jul 2026</td><td>Sep 2026</td><td>'+pill("In Progress","amber")+'</td></tr>'
    +'<tr><td>Early Site/Grading Permit</td><td>Aug 2026</td><td>Sep 2026</td><td>'+pill("Not Started","gray")+'</td></tr>'
    +'<tr><td>UG/Foundation Permit</td><td>Aug 22, 2026</td><td>Sep 22, 2026</td><td>'+pill("Not Started","gray")+'</td></tr>'
    +'<tr><td>Full Building Permit</td><td>Jan 15, 2027</td><td>Mar 15, 2027</td><td>'+pill("Not Started","gray")+'</td></tr>'
    +"</tbody></table></div></div>";
